...
| /api/servers | routes/servers.ts | 12: CRUD (`GET /`, `POST /`, `PUT /:id`, `DELETE /:id`), `POST /:id/test`, `POST /:id/ensure-docker`, `GET/POST/DELETE /:id/dns`, `GET /:id/containers`, `POST /:id/scan-protocols`, `POST /:id/import-protocol` |
